...
class HomieDevice {
 public:
  ...
  uint16_t PublishDirect(const String& topic, uint8_t qos, bool retain,
 ...
 private:
  ...
  bool bDoPublishDefaults = false;  // publish default retained values that did
                                    // not yet exist in the controller
